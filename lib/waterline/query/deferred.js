...
/**
  * Populate method which would ideally call populate from 
  * the adapter !
  * ONGOING WORK
  */
Deferred.prototype.populate = function(cb) {
  console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! in  populate !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
  console.log(this._context);
  console.log(cb);
  console.log(this._criteria);
  _adapter = this._context.adapter;
  collectionName = this._context._adapter.collection;
  var returnedValue = _adapter.populate(collectionName, this._criteria, cb);
  console.log('Value has returned @@@@@@@@@@@@@@@@@@@@@@@@@@@');
